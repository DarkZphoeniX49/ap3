...
namespace AP3_GestionHackathon
{
    public partial class FormHackathon : Form
    {
        ...
        {
            BSHackathon.DataSource = Modele.listeHackathons().Select(x => new { x.idhackathon, x.thematique, x.lieu, x.ville, x.dateheuredebuth, x.dateheurefinh, x.objectifs,x.nbMaxEquip,x.dateFinInscription, x.ORGANISATEUR.nom, x.ORGANISATEUR.prenom })
